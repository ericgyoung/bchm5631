...
# indexing all the promoter window vectors (6Kb)
...
# It really wouldn't matter for a symmetric window size but good to keep in mind the strand
# could matter.
...
This plot is pretty basic, so let's add some more meaningful legends and a title.
