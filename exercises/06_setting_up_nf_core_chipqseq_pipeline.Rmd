...
1) Config file:  tells nextflow how to talk to Fiji
...
Now we are going to set up the resources to be used on FIJI (be careful in practice
...
## files and then think about how it will scale. This run.sh file is for thousands
...
module load singularity/3.1.1 # 3.1.1 specifies version of singularity
...
ENCSR000BLH,2,/scratch/Shares/rinnclass/CLASS_2022/fastq/ENCFF000POQ.fastq.gz,,,

final nextflow.config
process {
  executor='slurm'
  queue='short'
  memory='32 GB'
...
#SBATCH --job-name=Hepg2_Pol_test
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=eryo3113@colorado.edu
#SBATCH --output=nextflow.out
#SBATCH --error=nextflow.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
--single_end \
--input design.csv \
--fasta /Shares/rinn_class/CLASS_2022/data/genomes/human/gencode/v32/GRCh38.p13.genome.fa \
--gtf /Shares/rinn_class/CLASS_2022/data/genomes/human/gencode/v32/gencode.v32.annotation.gtf \
--macs_gsize 3.2e9 \
--blacklist /scratch/Shares/rinnclass/CLASS_2022/data/hg38-blacklist.v2.bed \
--email eryo3113@colorado.edu \
-resume \
-c nextflow.config
