...
salmon_tpm <- read.csv("/Users/eryo3113/CLASS2022/EricY/bchm/exercises/analysis/18_running_RNA_seq/results/salmon/salmon_merged_gene_tpm.csv")
...
promoter_features_df <- read.csv("/Users/eryo3113/CLASS2022/EricY/bchm/exercises/analysis/12_peak_features/peak_occurence_dataframe.csv")
...
that emerged at ~250 DBPs on a promoter. That's a lot of proteins on
one promoter!
...
ggsave("figures/pheatmap_tmp_scaled.pdf")
# RESULT: 
...
ggplot(promoter_features_df, 
            aes(y = log2(tpm_homo_sapiens_hepg2 + 0.001), x =
            # aes(y = tpm_homo_sapiens_hepg2 + 0.001, x =
                  number_of_dbp, color = gene_type)) + 
