...
fl <- list.files("/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/07_runchipseq/data/results/bwa/mergedLibrary/macs/broadPeak/broad_peak", full.names = T)
summary(fl)
...
names(fl) <- gsub("/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/07_runchipseq/data/results/bwa/mergedLibrary/macs/broadPeak/broad_peak/|_peaks.broadPeak", "", fl)
...
new_filenames <- paste0("/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/07_runchipseq/data/results/bwa/mergedLibrary/macs/broadPeak/broad_peak/", names(fl), ".broadPeak")
