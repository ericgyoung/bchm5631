...
# Now let's run it.
 md5_results <- system("md5sum -c md5.txt",intern=TRUE)
 
# Nice they all look correct -- but let's save this result
write.csv(md5, "md5_check.csv")
```
...
samplesheet <- samplesheet %>%
            ...
            separate(sample_id, into = c("experiment_accession", "replicate"), remove = FALSE, sep = "_") %>%
...
base_path <- paste0("/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/17_API/fastq/")
