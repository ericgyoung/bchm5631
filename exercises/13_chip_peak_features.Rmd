...
source("~/CLASS2022/EricY/bchm/util/my_functions.R")
...
#consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/CLASS_2022/JR/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/consensus_peaks", 
  #                                           pattern = "*.bed",
   #                                          full.names = TRUE)
...
#                                              pattern = "*.bed",
#                                              full.names = TRUE)
filtered_consensus_peaks_files <- list.files("/Users/eryo3113/CLASS2022/EricY/bchm/exercises/analysis/11_consensus_peaks/filtered_consensus_peaks", 
                                             pattern = "*.bed",
                                             full.names = TRUE)
# lappy to import each file in file list 
#~/CLASS2022/EricY/bchm/exercises/analysis/11_consensus_peaks/filtered_consensus_peaks
filtered_consensus_peaks <- lapply(filtered_consensus_peaks_files, rtracklayer::import)
# adding names to rows
names(filtered_consensus_peaks) <- gsub("/Users/eryo3113/CLASS2022/EricY/bchm/exercises/analysis/11_consensus_peaks/filtered_consensus_peaks/|_filtered_consensus_peaks.bed","", filtered_consensus_peaks_files)
...
lncrna_mrna_promoters <- rtracklayer::import("/Users/eryo3113/CLASS2022/EricY/bchm/exercises/analysis/11_consensus_peaks/gene_annotation_files/lncRNA_mrna_promoters.gtf")
...
lncrna_mrna_genebody <- rtracklayer::import("/Users/eryo3113/CLASS2022/EricY/bchm/exercises/analysis/11_consensus_peaks/gene_annotation_files/lncrna_mrna_genebody.gtf")
...
We have a large group of different DBPs so let's import some annotations of which
...
destination_for_url <- "/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/12_peak_features/TF_annotations.xlsx"
...
human_tfs <- readxl::read_excel("/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/12_peak_features/TF_annotations.xlsx",
                                sheet = 2, skip = 1)
...
length(num_peaks_df[is.na(num_peaks_df$tf),]$tf)
# Ok looks good let's write it out:
write_csv(num_peaks_df, "/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/12_peak_features/num_peaks_df.csv")
...
Now let's also use our 'count_peaks_per_feature' function to use the 'occurrence' parameter
...
write.table(promoter_peak_occurence, "/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/12_peak_features/lncrna_mrna_promoter_peak_occurence_matrix.tsv")
...
```{R turning peak_occurence matrix into data.frame}
...
write_csv(peak_occurence_df, "/scratch/Shares/rinnclass/CLASS_2022/EricY/bchm/exercises/analysis/12_peak_features/peak_occurence_dataframe.csv")
