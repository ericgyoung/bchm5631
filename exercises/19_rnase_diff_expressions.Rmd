...
# writing this out to avoid loading Gencode in the future
...
counts <- read_csv("/Users/eryo3113/CLASS2022/EricY/bchm/exercises/analysis/18_running_RNA_seq/results/salmon/salmon_merged_gene_counts.csv")
...
rlog_counts_matrix <- read_rds("/path/log_counts_all.rds")
# Now reading in to check for start point in future
...
# Finalizing samplesheet for nuc vs cyto DEseq2
